...
const webMasters = {
  ...
  venue: "IT-444",
  rules: [
    "Participants will be provided with a sample design and a list of required features. They will need to use their creativity to design a website that meets these requirements.",
    "The marking system for this event will be based on creativity. Judges will be looking for originality, unique design elements, and innovative use of color, graphics, and typography.",
